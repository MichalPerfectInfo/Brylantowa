  ...
  <section id="o-inwestorze" className="py-20 bg-gray-50 scroll-mt-20">
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed text-lg">
        <p>
          Brylantowa Nieruchomości to firma deweloperska z ogromnym doświadczeniem w realizacji kameralnych osiedli mieszkaniowych. 
  ...
  {/* Obraz w tle dopasowany do całej karty */}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <a
            ...
            className="bg-primary-400 hover:bg-primary-600 text-white font-semibold px-6 py-3 rounded-lg text-lg transition-colors"
          >
            Zobacz więcej
          </a>
        </div>
